...
def get_games():
    ...
    return [GAME_DESERT_BUS, GAME_DIVEKICK, GAME_EARTHBOUND, GAME_DUCKGAME, GAME_GTA, GAME_POKEMON_FIRE_RED, GAME_POKEMON_EMERALD, GAME_HSR, GAME_JUMPKING, GAME_STICKFIGHT]
